...
int main()
{
  ...
  ImportPoints("C:\\Users\\enric\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell0Ds.csv",punti);
  std::vector<Segment> lati;
  lati.reserve(lati.size() + 4*n);
  ImportSegments("C:\\Users\\enric\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell1Ds.csv",punti,lati);
  std::vector<Cell> triangoli;
  triangoli.reserve(triangoli.size() + 3*n);
  ImportCells("C:\\Users\\enric\\Desktop\\progetto_PCS\\Projects\\Raffinamento\\Dataset\\Test1\\Cell2Ds.csv",punti, lati, triangoli);
  ...
  std::ofstream file("C:\\Users\\enric\\Desktop\\outputLati.csv");
